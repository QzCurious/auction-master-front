...
export function TextLink({
  ...
  return (
    <Link
      ...
      className={clsx(
        className,
        'text-zinc-950 underline decoration-zinc-950/50 underline-offset-2 data-[hover]:decoration-indigo-500 dark:text-white dark:decoration-white/50 dark:data-[hover]:decoration-white',
      )}
    />
  )
}
