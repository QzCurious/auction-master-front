      ...
      <ul className='mt-4 pl-6'>
        ...
        <li>
          ...
          <ol className='pl-5'>
            ...
            <li>
              若您同意我方所開出的收購金額，即可選擇「現金收購」，進行賣斷交易。您必須將物品寄來、或親送至我方倉儲據點，由我方再次確認；若您有超過20個以上、收購金額超過新台幣＄500元的物品，可享有寄件免運費之優惠。
            </li>
            <li>
        ...
        <li>
          ...
          <ol className='pl-5'>
            ...
            <li>
              若希望我們按照您所設定的期望金額上架日本雅虎拍賣，請選擇「託售」。您必須將物品寄來、或親送至我方倉儲據點，由我方再次確認；若您有超過20個以上、收購金額超過新台幣＄500元的物品，可享有寄件免運費之優惠。
            </li>
            <li>
              請注意，我方有可能根據物品的實際狀態而調整收購金額，您可以在上述頁面中查詢到完整而透明的現況資訊，用以判斷是否改變交易形式。
            </li>
            <li>
              若您確定要用定價銷售的形式託售，則我們會將物品以您設定的期望金額上架至日本雅虎拍賣。若物品成功售出，我們會將拍賣所得款項、扣除30%手續費後撥至您的「會員帳戶」→「帳戶紀錄」，讓您隨時提領；本平台將於當月15日或次月1日，將您所提領的款項匯至您設定的銀行帳戶。
            </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <ol className='pl-5'>
            ...
            <li>
              若希望我們將物品上架日本雅虎拍賣供人競標，請選擇「託售」。您必須將物品寄來、或親送至我方倉儲據點，由我方再次確認；若您有超過20個以上、最低估值超過新台幣＄500元的物品，可享有寄件免運費之優惠。
            </li>
            <li>
              請注意，我方有可能根據物品的實際狀態而調整收購金額以及估值，您可以在上述頁面中查詢到完整而透明的現況資訊，用以判斷是否改變交易形式。
            </li>
            <li>
              當您確定同意託售後，我們會將物品上架至日本雅虎拍賣，供人競標。若物品成功售出，我們會將拍賣所得款項、扣除30%手續費後撥至您的「會員帳戶」→「帳戶紀錄」，讓您隨時提領；本平台將於當月15日或次月1日，將您所提領的款項匯至您設定的銀行帳戶。
            </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <p>
            ...
            然而，這個估價只是參考而已，用來給您作為選擇交易形式的依據；最終還是得看您寄來的物品，實際上的狀況到底是怎樣，才能給出正式的估值。
          </p>
        </li>
        ...
        <li>
          <p>如果我不想交易了，可以取消嗎？</p>
          <p>
            當然可以，您可在上述的物品狀態頁面直接操作，取消交易。若您已將物品寄到我們這邊了，則需請您負擔寄回物品的運費，以及相關之作業費用。
          </p>
          <ol className='pl-5'>
        ...
        <li>
          ...
          <p>
            若您沒有主動取消託售的話，我們會再次安排物品上架，並依此原則重複直到物品售出為止；或者，您也可以主動取消交易。
          </p>
        </li>
        <li>
        ...
        <li>
          <p>那如果我的物品是託售，你們會跟我收取哪些費用？</p>
          <p>
            在託售的情況下，不管是「定價銷售」的形式，還是「期約金額收購」的形式，只要物品上到了日本雅虎拍賣，一旦成交（註：包含物品不幸被棄標後、您同意由我們以最低估值收購該物品的狀況），我們就是收取成交價格的30%作為手續費。
          </p>
        </li>
        ...
        <li>
          ...
          <p>
            另外一種狀況，如果您的物品被我們鑑定為無效物品，亦即狀態不佳難以估價，或者價值低於新台幣500元、不符合上架日本雅虎拍賣的效益，但您依然決定要指名我們託售的話，則我們會把物品放到台灣Facebook的相關社團進行販售。若成功售出，我們會收取成交金額的50%作為手續費；若未能成交，則比照上述說明，讓我們重新上架拍賣，或者由您支付運費及作業費
        ...
        <li>
          <p>
            如果我把物品寄給你們託售，結果物品在你們倉儲保存的期間發生損壞，你們怎麼處理？
          </p>
          <p>
