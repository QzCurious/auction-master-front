    ...
    <main className={clsx('mx-auto max-w-prose px-4', docStyle.doc)}>
      ...
      <ul className='mt-4 !list-[cjk-ideographic] pl-6'>
        ...
        <li>
          ...
          】或【期約金額收購】之方式，取得額外會員回饋金之期待權。日拍大師將告知會員轉售之平台上架資訊或連結網址，以利會員評估可能的會員回饋金。
        </li>
        <li>
        ...
        <li>
          ...
          】或【期約金額收購】之附約，日拍大師與會員所議定之價金及會員回饋金，將於日拍大師於轉售後一定期間內，一次支付。會員理解，如轉售過程因不可抗力或其他第三方原因而失敗，日拍大師僅需依最低保障金額或契約約定金額支付賣家，會員不得追索額外賠償。
        </li>
